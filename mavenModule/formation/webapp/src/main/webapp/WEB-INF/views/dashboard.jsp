...
<body>
    ...
    <footer class="navbar-fixed-bottom">
       <div class="container text-center">
            <ul class="pagination">
                <li>
                	<c:if test="${page.currentPage > 1}">
                    	<a href="/webapp/ListServlet?page=${page.currentPage-1}${nbByPageValue}${valueSearch}${orderValue}${ascendingValue}" aria-label="Previous">
              	...
              	<c:forEach var="i" begin="1" end="2">
              		<c:if test="${page.currentPage-(3-i) >= 1}">
              			<li><a href="/webapp/ListServlet?page=${page.currentPage-(3-i)}${nbByPageValue}${valueSearch}${orderValue}${ascendingValue}"><c:out value="${page.currentPage-(3-i)}"/></a></li>
              		</c:if>
              	</c:forEach>
              	<c:forEach var="i" begin="0" end="2">
              		<c:if test="${page.currentPage+i <= nbComputers}">
                        ...
                        <c:if test = "${page.currentPage+i ==  page.currentPage}">
              			...
              			<li class="${active}"><a href="/webapp/ListServlet?page=${page.currentPage+i}${nbByPageValue}${valueSearch}${orderValue}${ascendingValue}"><c:out value="${page.currentPage+i}"/></a></li>
              		</c:if>
              	</c:forEach>
              	<li>
              		<c:if test="${page.currentPage < nbComputers}">
                		<a href="/webapp/ListServlet?page=${page.currentPage+1}${nbByPageValue}${valueSearch}${orderValue}${ascendingValue}" aria-label="Next">
            ...
            <a href="/webapp/ListServlet?nbByPage=10${valueSearch}${orderValue}${ascendingValue}"><button type="button" class="btn btn-default ${active}">10</button></a>
            <c:set var="active" value=""/>
            <c:if test = "${page.itemsByPage == 50}">
               <c:set var="active" value="active"/>
            </c:if>
            <a href="/webapp/ListServlet?nbByPage=50${valueSearch}${orderValue}${ascendingValue}"><button type="button" class="btn btn-default ${active}">50</button></a>
            <c:set var="active" value=""/>
            <c:if test = "${page.itemsByPage == 100}">
               <c:set var="active" value="active"/>
            </c:if>
            <a href="/webapp/ListServlet?nbByPage=100${valueSearch}${orderValue}${ascendingValue}"><button type="button" class="btn btn-default ${active}">100</button></a>
        	</div>
        </div>
